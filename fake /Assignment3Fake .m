...
%     menuPoss= menuPoss(1:end-1)
    player2MoveIndex = listdlg('PromptString',{'pick your space:'},'ListString', stringMoves)
...
%     menuPoss= sprintf('% .0f,', possMoves);
%     menuPoss= menuPoss(1:end-1)
    player3MoveIndex = listdlg('PromptString',{'pick your space:'},'ListString', stringMoves)
...
%     menuPoss= sprintf('% .0f,', possMoves);
%     menuPoss= menuPoss(1:end-1)
    player4MoveIndex = listdlg('PromptString',{'pick your space:'},'ListString', stringMoves)
...
%     menuPoss= sprintf('% .0f,', possMoves);
%     menuPoss= menuPoss(1:end-1)
    player5MoveIndex = listdlg('PromptString',{'pick your space:'},'ListString', stringMoves)
